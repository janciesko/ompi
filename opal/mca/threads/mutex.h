 ...
 */
OPAL_DECLSPEC int opal_mutex_trylock(opal_mutex_t *mutex);
 ...
 * @param mutex         Address of the mutex.
 */
OPAL_DECLSPEC void opal_mutex_lock(opal_mutex_t *mutex);
 ...
 * @param mutex         Address of the mutex.
 */
OPAL_DECLSPEC void opal_mutex_unlock(opal_mutex_t *mutex);
 ...
 * @return              0 if the mutex was acquired, 1 otherwise.
 */
OPAL_DECLSPEC int opal_mutex_atomic_trylock(opal_mutex_t *mutex);
 ...
 * @param mutex         Address of the mutex.
 */
OPAL_DECLSPEC void opal_mutex_atomic_lock(opal_mutex_t *mutex);
 ...
 * @param mutex         Address of the mutex.
 */
OPAL_DECLSPEC void opal_mutex_atomic_unlock(opal_mutex_t *mutex);
